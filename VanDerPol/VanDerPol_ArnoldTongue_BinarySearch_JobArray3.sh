...
matlab -nodisplay -singleCompThread -r "VanDerPol_ArnoldTongue_BinarySearch_JobArray2Wrapper($index, '$output', $input_periods, $tolerance, $Ntrials, $population_average, $$entrainment_threshold); exit;"
