...
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, false, 0.75, 11, 2)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, true, 0.75, 11, 2)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, false, 0.75, 9, 2)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, true, 0.75, 9, 2)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, false, 0.75, 10, 1.8)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, true, 0.75, 10, 1.8)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, false, 0.75, 10, 2.2)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, true, 0.75, 10, 2.2)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, false, 0.75, 10, 2)
% VanDerPol_ArnoldTongue_BinarySearch('output/', inf, 4:0.2:18, 0.01, 500, true, 0.75, 10, 2)

function VanDerPol_ArnoldTongue_BinarySearch(output_folder, volume, input_periods, input_amplitude_tolerance, Ntrials, population_average, entrainment_threshold, parameterB, parameterD)
    addpath('../');
...
%     max_frequency = inf;
    ...
    S = struct();
    S.parameterB = parameterB;
    S.parameterD = parameterD;
    S.volume = volume;
...
%     for i=1:length(input_periods)
    ...
    filename = [output_folder, 'VanDerPol_ArnoldTongue_BinarySearch__B_', num2str(parameterB), '_d_', num2str(parameterD), '_volume=', num2str(S.volume), '_population=', num2str(S.population_average), '_', date_string, '.mat'];
