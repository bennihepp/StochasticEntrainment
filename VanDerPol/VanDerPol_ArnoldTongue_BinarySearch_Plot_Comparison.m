...
if export_eps
    if S2.population_average
        filename = ['../paper/figures/vanderpol_comparison_arnold_tongue_population_volume1=', num2str(S1.volume), '_volume2=', num2str(S2.volume), '.eps'];
    else
        filename = ['../paper/figures/vanderpol_comparison_arnold_tongue_volume1=', num2str(S1.volume), '_volume2=', num2str(S2.volume), '.eps'];
    end
