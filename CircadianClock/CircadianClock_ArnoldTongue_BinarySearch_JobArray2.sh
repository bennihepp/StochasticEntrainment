...
matlab -nodisplay -singleCompThread -r "CircadianClock_ArnoldTongue_BinarySearch_JobArray2Wrapper($index, '$output', $volume, $input_periods, $tolerance, $Ntrials, $population_average, $Nthreads); exit;"
