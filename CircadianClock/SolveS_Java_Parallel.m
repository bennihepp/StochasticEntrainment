...
%     omega = sde.getOmega();
    sdeFactory = ch.ethz.bhepp.sdesolver.models.CircadianClockDrosophilaSdeFactory(volume, inputFunction);
...
%     stepperFactory.addStepHook(boundedStateHook);
    ...
    sdeSolutions = parallelSolver.solve(Ntrials, 0, x0Matrix, tf, recordStep, printMessages);
